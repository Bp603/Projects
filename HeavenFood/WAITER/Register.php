            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="username" placeholder="Your Name" pattern="[A-Za-z]{0,}"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_2" id="password_2" placeholder="Repeat your password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" />
                            </div>
                            <div class="form-group">
                    ...
                    <div class="signup-image">
                        <figure><img src="./REGISTER/images/BHABHO.jpg" alt="sing up image"></figure>
