      ...
      <div class="container">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-12 d-flex justify-content-center">
              <form name="f1" method="post" action="#">
                <ul id="menu-flters" id="ctname" name="ctname">
                  ...
                  ?>
                    <li onclick="window.location.href='menu.php?clicked=<?PHP echo $answ['CTID']; ?>'" data-filter=".filter-starters" value="<?PHP echo $answ['CTID']; ?>"><?php echo $answ['CTNAME']; ?></li>
                  <?php
                  }
        ...
        ?>
            ...
            <div class="container">
              ...
              ?>
                  <div class="col-md-4">
                    <form method="post" name="frm" action="ORDER.php?action=add&id=<?php echo $row["MID"]; ?>">
                      <div class="menu" style="border:1px solid #333; background-color:#0e0b0b; border-radius:10px; padding:16px;" align="center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <!-- <input type="submit" name="add_to_cart" style="margin-top:5px;" class="btn btn-success" value="Parcel" /> -->
                        </span>
                        </div>
                ...
                <div class="col-md-4">
                  ...
                  <form method="post" name="frm" action="order.php?action=add&id=<?php echo $row["MID"]; ?>">
                    ...
                    <div class="menu" style="border:1px solid #333; background-color:#0e0b0b; border-radius:10px; padding:16px;" align="center" data-aos="fade-up" data-aos-delay="100">
                      ...
                      <br>
                      <span>
                      <input type="submit" id="ordr" name="add_to_cart" style="margin-top:5px;" class="btn btn-success" value="Order" />&nbsp;&nbsp;
                      <!-- <input type="submit" id="parcel" name="add_to_cart" style="margin-top:5px;" class="btn btn-success" value="Parcel" /> -->
                      </span>
                      </div>
        ...
        if (isset($_REQUEST["clicked"])) {
          ...
          $sql5 = "select * from CATEGORY WHERE CTID={$_REQUEST['clicked']}";
